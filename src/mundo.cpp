...
Mundo::Mundo(Engine *engine, const char *path_ground, const char *path_ores){
    this->engine = engine;
...
bool Mundo::isOccupied(int x, int y){
    return occupied[x][y];
}

void Mundo::setOccupied(int x, int y, bool value){
    occupied[x][y] = value;
}

void Mundo::spawnTreasure(){
...
int Mundo::catchTreasure(int x, int y){
...
SDL_Point Mundo::getTreasurePosition(){
